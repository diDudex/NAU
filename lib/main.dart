...
import 'package:nau/pages/admin/admin_panel_screen.dart';
...
class MainApp extends StatelessWidget {
  ...
  '/perfilconfig': (context) {
    final driverId = AuthService().getCurrentUid();
    return PerfilConfig(driverId: driverId);
  },
  '/paneladmin': (context) => const PanelAdministrador(), // <-- Agregado
},
