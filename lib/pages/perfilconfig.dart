...
class PerfilConfig extends StatefulWidget {
  ...
  const PerfilConfig({super.key, required this.driverId});
...
class PerfilConfigState extends State<PerfilConfig> {
  ...
  Future<void> _updateProfile() async {FocusScope.of(context).unfocus();
  ...
  Future<void> _loadUserData() async {
    try {
      ...
      driverData = await databaseProvider.driverProfile(widget.driverId);
      //finalizar la carga
      setState(() {
        _isLoading = false;
      });
